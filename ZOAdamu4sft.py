...
# 加载模型和分词器
model_path = f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/zoadamu/{task_name[task_id-1]}"
...
training_args = SFTConfig(
        output_dir=f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/zoadamu/{task_name[task_id]}",
...
# 保存模型
model.save_pretrained(f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/zoadamu/{task_name[task_id]}")
