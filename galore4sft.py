...
# 加载模型和分词器
model_path = f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/gelore/{task_name[task_id - 1]}"
...
param_groups = [{'params': regular_params}, 
                {'params': galore_params, 'rank': local_rank, 'update_proj_gap': 50, 'scale': 1.0, 'proj_type': 'std'}]
...
trainer_args = TrainingArguments(
    output_dir=f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/gelore/{task_name[task_id]}",
    num_train_epochs=1,
...
# 保存模型
model.save_pretrained(f"/HOME/hitsz_qcchen/hitsz_qcchen_1/new_disk/SPUpdater-main/fined_chkpts/gelore/{task_name[task_id]}")
